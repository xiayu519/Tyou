...
- **AND** it does not include a Codex workflow section or Codex rule map
...
- **WHEN** Codex workflow rules, task levels, OpenSpec gates, memory rules, or sensors are documented
- **THEN** they are maintained in `AGENTS.md`, `.agents/skills/*`, `.codex/rules/`, `Books/AI-Development-Workflow.md`, or `openspec/specs/codex-ai-workflow/`
