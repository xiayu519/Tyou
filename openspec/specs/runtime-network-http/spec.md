# runtime-network-http Specification

## Purpose
Define the Tyou runtime HTTP and network contract for callback API compatibility, mini-game request/socket adaptation, request cancellation, error events, WebSocket behavior, and NetNode lifecycle cleanup.
