...
The project overview documentation MUST describe current Tyou runtime contracts using local implementation facts, including the global `tyou.*` module entry and required scene nodes when they are part of startup behavior.
...
#### Scenario: External report is used for documentation
