...
function Get-WikiIncludes {
    ...
    if (-not (Test-Path -LiteralPath $Path)) {
        return @("README.md", "Books/**/*.md", ".codex/rules/**/*.md", "openspec/specs/**/*.md", ".agents/skills/**/SKILL.md", "AGENTS.md")
    }
    $patterns = @()
    $inInclude = $false
    ...
    if ($patterns.Count -eq 0) {
        $patterns = @("README.md", "Books/**/*.md", ".codex/rules/**/*.md", "openspec/specs/**/*.md", ".agents/skills/**/SKILL.md", "AGENTS.md")
    }
    return $patterns
}
